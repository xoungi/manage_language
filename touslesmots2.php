...
<html lang="fr">
	<head>
		...
		<title>Tous les mots</title>
		<?php include_once('includes/connexion.php'); $champs_lex = ""; ?>
	</head>
	<body>
		<div><h2><a href="index.php">Home</a></h2><hr><br></div>
		<table>
			<tr>
				<?php echo "<th><b><a href=\"touslesmots2.php?classement=voc_eng.id_voc\">Id</a></b></th>"; ?>
				<?php echo "<th><b><a href=\"touslesmots2.php?classement=voc\">Voc</a></b></th>"; ?>
				<?php echo "<th><b><a href=\"touslesmots2.php?classement=trad\">Traduction</a></b></th>"; ?>
				<?php echo "<th><b><a href=\"touslesmots2.php?classement=champs\">Champs</a></b></th>"; ?>
				<?php echo "<th><b><a href=\"touslesmots2.php?classement=nat\">Nature</a></b></th>"; ?>
				<th><b>Modif.</b></th>
			</tr>
			<?php
